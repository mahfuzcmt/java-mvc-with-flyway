        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "   <thead>\n" +
                    "     <tr>\n" +
                    "       <th><a style=\"margin-right:5px;\" ng-if=\"expandingProperty.sortable\" ng-click=\"sortBy(expandingProperty)\">{{expandingProperty.displayName || expandingProperty.field || expandingProperty}}</a><span ng-if=\"!expandingProperty.sortable\">{{expandingProperty.displayName || expandingProperty.field || expandingProperty}}</span><i ng-if=\"expandingProperty.sorted\" class=\"{{expandingProperty.sortingIcon}}\"></i></th>\n" +
                    "       <th ng-repeat=\"col in colDefinitions\"><a style=\"margin-right:5px;\" ng-if=\"col.sortable\" ng-click=\"sortBy(col)\">{{col.displayName || col.field}}</a><span ng-if=\"!col.sortable\">{{col.displayName || col.field}}</span><i ng-if=\"col.sorted\" class=\"{{col.sortingIcon}} \"></i></th>\n" +
                    "     </tr>\n" +
                    "   </thead>\n" +
                    "   <tbody>\n" +
            ...
            function ($timeout, treegridTemplate) {
                ...
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        attrs.sortedAsc = attrs.sortedAsc ? attrs.sortedAsc : 'icon-file fa fa-caret-down';
                        attrs.sortedDesc = attrs.sortedDesc ? attrs.sortedDesc : 'icon-file fa fa-caret-up';
